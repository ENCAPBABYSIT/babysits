    ...
    <header className='w-[100%] px-10 shadow-md sticky top-0 z-1'>
        <div className='flex justify-between xl:w-1/8 items-center '>
          ...
          <div className='mx-auto lg:mx-0'>
            ...
            menu custom:flex custom:flex-col custom:bg-[#151418] custom:items-start custom:absolute custom:top-[70px] custom:left-0 custom:w-full custom:z-[1] custom:scale-y-0 custom:transform-gpu custom:origin-top custom:transition-transform custom:duration-300 custom:ease-in-out custom:shadow-custom'>
